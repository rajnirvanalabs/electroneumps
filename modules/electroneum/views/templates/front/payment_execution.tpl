<div class="payment_carrier">
   {capture name=path}
        <a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" title="{l s='Go back to the Checkout' mod='electroneum'}">
            {l s='Checkout' mod='electroneum'}
        </a>
        <span class="navigation-pipe">{$navigationPipe}</span>
        {l s='Check payment' mod='electroneum'}
    {/capture}
    ...
    <h1 class="page-heading">{l s='Order summary' mod='electroneum'}</h1>

    {assign var='current_step' value='payment'}
    {include file="$tpl_dir./order-steps.tpl"}
<div class="monero">
    <form action="{$link->getModuleLink('electroneum', 'validation', [], true)|escape:'html'}" method="post">
