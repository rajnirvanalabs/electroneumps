...
class electroneumValidationModuleFrontController extends ModuleFrontController
{
    ...
    $c = $currency->iso_code;
		...
		$status = "We are waiting for your payment to be confirmed by the Electroneum network.";

		$this->electroneum_daemon = new Electroneum_Library('http://'. $daemon_address .'/json_rpc');
